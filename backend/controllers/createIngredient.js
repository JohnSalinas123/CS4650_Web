...
const schema = new mongoose.Schema({ name: String,catogory: String, calories: Number });
const Ingredients = mongoose.model('Ingredient', schema);
...
export const createIngredients = async(req, res) => {
	...
	const newIngredient = await await Ingredient.create({ name: name , category: category , calories: calories });
